...
const ChatToggle: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 right-8 z-50 flex items-center justify-center w-16 h-16 bg-[#5C89E8] text-white rounded-full shadow-2xl hover:bg-[#3366CC] hover:scale-110 active:scale-95 transition-all duration-300 group"
      aria-label="Открыть чат"
    >
      <span className="absolute inset-0 rounded-full bg-[#5C89E8] animate-ping opacity-20 group-hover:opacity-40"></span>
      
      <MessageSquareText className="w-8 h-8 relative z-10" />
